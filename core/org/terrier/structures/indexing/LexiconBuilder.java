...
public class LexiconBuilder
{
	 ...
	 * @throws IOException
	 */
	public static void reAssignTermIds(Index index, String structureName, int numEntries) throws IOException
	{
	...
	private static Iterator<Entry<String, LexiconEntry>> getLexInputStream(
			Index index, String structureName)  throws IOException
	{
	...
	@SuppressWarnings("unchecked")
	private static LexiconOutputStream<String> getLexOutputStream(Index index, String structureName) throws IOException
	{
		return new FSOMapFileLexiconOutputStream(
				index.getPath(), index.getPrefix(), 
				structureName, 
